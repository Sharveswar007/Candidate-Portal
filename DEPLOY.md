# Deployment Guide for HIRENEX

This guide covers how to deploy the HIRENEX application. The recommended stack is **Vercel** for the frontend/API and **Supabase** for the backend/database.
