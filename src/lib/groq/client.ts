...
export async function streamChatCompletion(
    ...
    try {
        console.log("\n🤖 ============================================");
        console.log("🤖 GENERATED WITH GROQ AI (Streaming)");
...
export async function generateChatCompletion(
    ...
    console.log("\n🤖 ============================================");
    console.log("🤖 GENERATED WITH GROQ AI (Chat Completion)");
    console.log("🤖 Model: llama-3.1-8b-instant");
    console.log("🤖 ============================================\n");
...
Make the problem statement clear and unambiguous.`;
    ...
    console.log("\n🤖 ============================================");
    console.log("🤖 GENERATED WITH GROQ AI (Coding Challenge)");
    console.log("🤖 Model: llama-3.1-8b-instant");
...
Evaluate: Contact info, Education, Experience, Skills, Projects, Formatting, ATS compatibility.`;
    ...
    console.log("🤖 Model: llama-3.1-8b-instant");
    console.log("🤖 Target Career:", targetCareer || "technology");
    console.log("🤖 ============================================\n");
